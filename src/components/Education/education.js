...
const Education = () => {
    return (
        <div>
            <section id="edu" className="edu-header">
            ...
            <section className="edu-cards">
                ...
                <a href="https://drive.google.com/file/d/1d-YMT2BR65_TYrmyK4FDAtQFqkpEzwnR/view?usp=sharing" target="_blank" rel="noopener noreferrer">
